...
| `Quilt4Net:Content` | Toolkit / Blazor | Content management options (application name, server address, `WarmUpEnabled` bulk cache warm-up and its periodic re-warm, failure back-off). |
