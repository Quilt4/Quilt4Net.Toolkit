...
public class LogEnvironmentSelectorIncidentTests : BunitContext
{
    ...
    private sealed class ThrowingApplicationInsightsService : IApplicationInsightsService
    {
        ...
        public IAsyncEnumerable<LogCountByServiceCell> GetLogCountByServiceAsync(IApplicationInsightsContext context, IEnumerable<string> environments, TimeSpan timeSpan, CancellationToken cancellationToken = default) => Throw<LogCountByServiceCell>();
